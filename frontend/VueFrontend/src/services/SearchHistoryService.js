 ...
 *
 * @example
 * addSearchHistory('vintage cars', 'jwt-token')
...
export function addSearchHistory(searchQuery, token) {
    ...
    return searchHistoryApi.add(searchHistoryRequestDTO)
        .then(searchHistoryResponseDTO => searchHistoryResponseDTO)
        .catch(error => {
...
export function getSearchHistory(token) {
    ...
    return searchHistoryApi.findByUserId()
        .then(searchHistoryListResponseDTO => searchHistoryListResponseDTO)
        .catch(error => {
