...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDocumentationFindNo.UserResponseDTO();
  });
  ...
  describe('UserResponseDTO', function() {
    it('should create an instance of UserResponseDTO', function() {
      ...
      //var instance = new OpenApiDocumentationFindNo.UserResponseDTO();
      //expect(instance).to.be.a(OpenApiDocumentationFindNo.UserResponseDTO);
    });
