...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDocumentationFindNo.BookmarkControllerApi();
  });
  ...
  describe('BookmarkControllerApi', function() {
    ...
    describe('getUserBookmarks', function() {
      it('should call getUserBookmarks successfully', function(done) {
        //uncomment below and update the code to test getUserBookmarks
        //instance.getUserBookmarks(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
