...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDocumentationFindNo.SearchHistoryControllerApi();
  });
  ...
  describe('SearchHistoryControllerApi', function() {
    ...
    describe('findByUserId', function() {
      it('should call findByUserId successfully', function(done) {
        //uncomment below and update the code to test findByUserId
        //instance.findByUserId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
